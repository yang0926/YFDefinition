...
#ifndef YFDefinitionHeader_h
#define YFDefinitionHeader_h
...
// clear背景颜色
#define YFClearColor [UIColor clearColor]
...
//7.设置 view 圆角和边框
#define YFViewBorderRadius(View, Radius, Width, Color)\
\
...
//8.由角度转换弧度 由弧度转换角度
#define YFDegreesToRadian(x) (M_PI * (x) / 180.0)
#define YFRadianToDegrees(radian) (radian*180.0)/(M_PI)

//9.设置加载提示框（第三方框架：Toast）
#define YFToast(str)              CSToastStyle *style = [[CSToastStyle alloc] initWithDefaultStyle]; \
